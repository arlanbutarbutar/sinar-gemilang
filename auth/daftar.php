        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-center py-5 px-4 px-sm-5">
              <h4>Daftar Akun Sinar Gemilang</h4>
              <h6 class="fw-light">Daftarkan akun kamu untuk mulai perjalanan.</h6>
              <form class="pt-3" action="" method="POST" autocomplete="off">
                ...
                <div class="mt-3">
                  <button type="submit" name="daftar" class="btn btn-block btn-lg font-weight-medium auth-form-btn text-white" style="background-color: #009688;">Daftar</button>
                </div>
              </form>
              <p class="mt-3 d-flex justify-content-center">Sudah punya akun? <a href="./" class="nav-link p-0 font-weight-bold" style="color: #009688;">Masuk</a></p>
            </div>
          </div>
        </div>
      </div>
